...
import { ArchonLogo, CopyButton, SeverityPill } from "@/components/archon";
...
export default async function PublicReportPage({ params }: { params: Promise<{ reportId: string }> }) {
  ...
  const proof = proofResult.rows[0] ?? null;
