...
<div className="not-prose my-6 rounded-card border border-brand-500/25 bg-surface-2 p-5 shadow-card">
  <p className="m-0 text-xs font-semibold uppercase tracking-[0.18em] text-brand-700">Archon Whitepaper · V2.9</p>
  <p className="mt-2 text-sm text-body">A public, technical overview of Archon's audit engine, Mantle gas optimization system, ERC-8004 identity model, proof architecture, challenge ledger, business model, and roadmap.</p>
  <div className="mt-4 flex flex-wrap gap-2">
    <a href="/docs/archon-whitepaper.pdf" className="inline-flex rounded-input bg-green-500 px-4 py-2 text-sm font-bold text-on-green shadow-sm hover:bg-green-400">Download PDF</a>
...
1. Abstract
2. The problem
3. Thesis: verifiable DevTools
4. System architecture
5. The Audit Engine
6. The Mantle Gas Optimization Engine
7. ERC-8004 identity and on-chain proofs
8. Public validation and challenge ledger
9. Trust and verifiability model
10. Business model and GTM
11. Roadmap
12. Security, limitations, and references
