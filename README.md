<p align="center">
  <img src="docs/assets/archon-hero-banner.png" alt="Archon — verifiable DevTools for Mantle" width="900" />
</p>
...
| **GitHub App + autofix** | ✅ Live | PR check + single updating comment (findings, gas diff), policy via `archon.config.json`, `/archon fix` opens compile-validated autofix PRs on Archon's own branches (installed on `Franlinozz/Archon` + `archon-gas-action-demo`) | [GitHub App docs](https://archonaudit.xyz/docs/platform-api/github-app) |
