...
| **VS Code** | Diagnostics in the editor, safe gas quick fixes as local Code Actions, per-opportunity gas lenses — thin client of the public API ([.vsix release](https://github.com/Franlinozz/Archon/releases/tag/vscode-v0.1.0); Marketplace listing next) | [Editor docs](https://archonaudit.xyz/docs/platform-api/editor-integration) |
